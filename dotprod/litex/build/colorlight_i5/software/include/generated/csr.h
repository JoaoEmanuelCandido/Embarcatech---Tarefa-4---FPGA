//--------------------------------------------------------------------------------
// Auto-generated by LiteX (9bd2c1b8e) on 2025-10-02 10:18:35
//--------------------------------------------------------------------------------
...
/* DOTPROD Registers */
#define CSR_DOTPROD_BASE (CSR_BASE + 0x0L)
#define CSR_DOTPROD_START_ADDR (CSR_BASE + 0x0L)
#define CSR_DOTPROD_START_SIZE 1
#define CSR_DOTPROD_DONE_ADDR (CSR_BASE + 0x4L)
#define CSR_DOTPROD_DONE_SIZE 1
#define CSR_DOTPROD_RESULT_ADDR (CSR_BASE + 0x8L)
#define CSR_DOTPROD_RESULT_SIZE 2
...
/* DOTPROD Access Functions */
static inline uint32_t dotprod_start_read(void) {
	return csr_read_simple((CSR_BASE + 0x0L));
}
static inline void dotprod_start_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x0L));
}
static inline uint32_t dotprod_done_read(void) {
	return csr_read_simple((CSR_BASE + 0x4L));
}
static inline uint64_t dotprod_result_read(void) {
